...
def generate_launch_description() -> LaunchDescription:
    args = [
        ...
        DeclareLaunchArgument("velocity_epsilon", default_value="0.015"),
        ...
        DeclareLaunchArgument("min_current_ratio", default_value="0.06"),
        DeclareLaunchArgument("backoff_seconds", default_value="0.20"),
        DeclareLaunchArgument("min_search_travel", default_value="0.08"),
        DeclareLaunchArgument("max_expected_offset", default_value="0.036"),
